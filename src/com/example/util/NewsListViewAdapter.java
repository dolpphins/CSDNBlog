...
public class NewsListViewAdapter extends BaseAdapter {
	...
	//view对象缓存
	private HashMap<Integer,SoftReference<LinearLayout> > viewCache = new HashMap<Integer,SoftReference<LinearLayout> >();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		{
			TextView title = (TextView) viewCache.get(position).get().findViewById(R.id.news_title);
			TextView summary = (TextView) viewCache.get(position).get().findViewById(R.id.summary);
		...
		//头像
		ImageView head_picture = (ImageView) linearLayout.findViewById(R.id.head_picture);
		...
		//摘要
		TextView summary = (TextView) linearLayout.findViewById(R.id.summary);
